...
import { CalendarDays, ArrowRight, Star, Heart, Share2, MoreHorizontal } from "lucide-react";
import { motion } from "framer-motion";

export default function Page() {
  const items = ["Tech Symposium 2026","Alumni Mixer","Hackathon Kickoff","Career Fair","Guest Lecture: AI","Spring Festival"];
  
  return (
    <PageTransition title="Campus Events" description="Find and register for upcoming workshops, guest lectures, and social gatherings." icon={CalendarDays}>
