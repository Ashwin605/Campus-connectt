...
import { User, ArrowRight, Star, Heart, Share2, MoreHorizontal } from "lucide-react";
import { motion } from "framer-motion";

export default function Page() {
  const items = ["Academic Record","Project Portfolio","Work Experience","Skills & Endorsements","Certifications","Recommendations"];
  
  return (
    <PageTransition title="Your Profile" description="Manage your portfolio, academic achievements, and public presence." icon={User}>
