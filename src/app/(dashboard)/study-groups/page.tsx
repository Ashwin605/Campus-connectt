...
import { BookOpen, ArrowRight, Star, Heart, Share2, MoreHorizontal } from "lucide-react";
import { motion } from "framer-motion";

export default function Page() {
  const items = ["CS101 Finals Prep","Physics Mechanics","Organic Chem Lab","Calculus III","Macroeconomics","Literature Review"];
  
  return (
    <PageTransition title="Study Groups" description="Collaborate with classmates. Find study partners for your current courses." icon={BookOpen}>
