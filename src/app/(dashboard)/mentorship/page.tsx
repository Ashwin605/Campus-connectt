...
import { GraduationCap, ArrowRight, Star, Heart, Share2, MoreHorizontal } from "lucide-react";
import { motion } from "framer-motion";

export default function Page() {
  const items = ["Alice Smith (Google)","Bob Jones (McKinsey)","Carol White (Apple)","Dave Brown (Goldman)","Eve Davis (Startup)","Frank Miller (Tesla)"];
  
  return (
    <PageTransition title="Mentorship" description="Get matched with industry professionals and senior students for guidance." icon={GraduationCap}>
