...
import { Rocket, ArrowRight, Star, Heart, Share2, MoreHorizontal } from "lucide-react";
import { motion } from "framer-motion";

export default function Page() {
  const items = ["EcoTech Solutions","FinHealth App","AI Tutors","BlockChain Logistics","Food Delivery Drone","VR Education"];
  
  return (
    <PageTransition title="Startup Hub" description="Find co-founders, pitch ideas, and connect with student investors and mentors." icon={Rocket}>
