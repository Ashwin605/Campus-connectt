...
import { Store, ArrowRight, Star, Heart, Share2, MoreHorizontal } from "lucide-react";
import { motion } from "framer-motion";

export default function Page() {
  const items = ["MacBook Pro M3","Calculus Textbook","Mini Fridge","Desk Lamp","Bicycle","Noise Cancelling Headphones"];
  
  return (
    <PageTransition title="Marketplace" description="Buy, sell, or trade textbooks, electronics, and dorm essentials with peers." icon={Store}>
