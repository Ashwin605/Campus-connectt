...
import { MessageSquare, ArrowRight, Star, Heart, Share2, MoreHorizontal } from "lucide-react";
import { motion } from "framer-motion";

export default function Page() {
  const items = ["Study Group Chat","Project Team Alpha","Sarah Jenkins","Robotics Club","Michael Chen","Hackathon Team"];
  
  return (
    <PageTransition title="Messages" description="Chat with your connections, club members, and project teammates securely." icon={MessageSquare}>
