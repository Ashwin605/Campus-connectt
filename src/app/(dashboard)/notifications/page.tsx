...
import { Bell, ArrowRight, Star, Heart, Share2, MoreHorizontal } from "lucide-react";
import { motion } from "framer-motion";

export default function Page() {
  const items = ["New Connection Request","Event Reminder","Club Meeting Moved","Job Application Update","New Message","System Maintenance"];
  
  return (
    <PageTransition title="Notifications" description="Stay updated on event changes, new connections, and important announcements." icon={Bell}>
