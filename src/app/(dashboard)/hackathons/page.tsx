...
import { Code, ArrowRight, Star, Heart, Share2, MoreHorizontal } from "lucide-react";
import { motion } from "framer-motion";

export default function Page() {
  const items = ["Global Hack 2026","HealthTech Challenge","FinTech Disrupt","Green Energy Hack","AI for Good","Web3 Builder"];
  
  return (
    <PageTransition title="Hackathons" description="Form teams, compete in campus-wide challenges, and showcase your projects." icon={Code}>
