...
import { Settings, ArrowRight, Star, Heart, Share2, MoreHorizontal } from "lucide-react";
import { motion } from "framer-motion";

export default function Page() {
  const items = ["Account Preferences","Privacy & Security","Notification Settings","Appearance","Integrations","Billing"];
  
  return (
    <PageTransition title="Settings" description="Customize your preferences, privacy options, and notification behaviors." icon={Settings}>
