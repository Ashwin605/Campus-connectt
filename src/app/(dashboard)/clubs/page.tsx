...
import { Building2, ArrowRight, Star, Heart, Share2, MoreHorizontal } from "lucide-react";
import { motion } from "framer-motion";

export default function Page() {
  const items = ["Robotics Club","Debate Society","Investment Group","Photography Club","AI Researchers","Design Thinkers"];
  
  return (
    <PageTransition title="Clubs & Communities" description="Discover and join vibrant campus organizations. Manage your memberships here." icon={Building2}>
