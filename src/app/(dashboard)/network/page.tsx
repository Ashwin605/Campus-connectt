...
import { Users, ArrowRight, Star, Heart, Share2, MoreHorizontal } from "lucide-react";
import { motion } from "framer-motion";

export default function Page() {
  const items = ["Sarah Jenkins","Michael Chen","Dr. Emily Carter","Alex Rivera","Jessica Wong","David Kim"];
  
  return (
    <PageTransition title="Network" description="Connect with peers, alumni, and faculty based on shared interests and goals." icon={Users}>
